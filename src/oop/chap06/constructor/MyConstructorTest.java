...
public class MyConstructorTest {
	public static void main(String[] args) {
		...
		MyConstructor obj2 =
							new MyConstructor("장동건","jang", "1234");
		...
		MyConstructor obj3 =
					new MyConstructor("장동건","jang", "1234","짱");
		...
		MyConstructor obj4 =
			new MyConstructor("장동건","jang", "1234","짱","서울",1000);
		System.out.println(obj4.getName()+","+obj4.getId()+","
				+obj4.getPass()+","+obj4.getNickname()
				+","+obj4.getAddr()+","+obj4.getPoint());
	}
}
