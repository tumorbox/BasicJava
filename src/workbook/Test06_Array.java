...
public class Test06_Array {
	public static void main(String[] args) {
		...
		/*
		 * System.out.println(s1.getName()+" Æò±Õ:"+s1.getAvg()+ " ÇĞÁ¡:"+s1.getGrade());
		 * System.out.println(s2.getName()+" Æò±Õ:"+s2.getAvg()+ " ÇĞÁ¡:"+s2.getGrade());
		 * System.out.println(s3.getName()+" Æò±Õ:"+s3.getAvg()+ " ÇĞÁ¡:"+s3.getGrade());
		 */
